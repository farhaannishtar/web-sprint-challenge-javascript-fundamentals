...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(animalsArray){
    /*Your Code Here*/
    return animalsArray.map((element) => {
  ...
  */
  ...
  function lowPopulationAnimals(animalsArray){
    /*Your Code Here*/
    return animalsArray.filter((element) => {
  ...
  */
  ...
  function USApop(animalsArray){
    /*Your Code Here*/
    const totalPopulation = animalsArray.reduce((accumulator, currentValue) => {
...
/* 🐴🐴🐴 Step 3: Surface Area Method 🐴🐴🐴
  Create another method called surfaceArea using CuboidMaker's prototype that returns the surface area of a given cuboid's 
